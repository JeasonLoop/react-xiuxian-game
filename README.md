...
当前版本: **v0.3.3.1** (2026-03-25)

查看完整的版本更新历史和功能计划，请访问 [CHANGELOG.md](public/CHANGELOG.md)。

### 最近更新（v0.3.3.1）

- 💰 **经济平衡**: 商店价格与回收价改为境界动态倍率，前中后期资源曲线更平滑
- 🎫 **抽奖优化**: 新增 50 抽传说/仙品软保底，并加入重复灵宠灵石补偿
- 📆 **每日任务修复**: 修复秘境/宗门任务在失败场景下误加进度的问题
- 🏡 **洞府修复**: 自动收获与手动收获规则统一，支持图鉴更新与奖励结算
